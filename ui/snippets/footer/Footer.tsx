...
const FRONT_VERSION_URL = `https://github.com/soileum/frontend/tree/${config.UI.footer.frontendVersion}`;
const FRONT_COMMIT_URL = `https://github.com/soileum/frontend/commit/${config.UI.footer.frontendCommit}`;
...
const Footer = () => {
  ...
  const BLOCKSCOUT_LINKS = [
    ...
    },
    {
      ...
      iconSize: "20px",
      text: "Telegram",
      url: "https://t.me/soileumnetwork",
    },
    {
      icon: "social/facebook_filled" as const,
      iconSize: "18px",
      text: "Facebook",
      url: "https://www.facebook.com/soileum.network",
    },
    {
      icon: "social/twitter" as const,
      iconSize: "18px",
      text: "X (ex-Twitter)",
      url: "https://twitter.com/soileum_network",
    },
    {
    ...
    },
    {
      ...
      iconSize: "20px",
      text: "Donate",
      url: "https://github.com/sponsors/soileum",
    },
  ];
      ...
      return (
        <Box gridArea={gridArea}>
          ...
          <Box mt={6} alignItems="start" fontSize="xs" lineHeight={5}>
            ...
            <Text>
              Copyright {copy} Soileum Network 2024-
    ...
    return (
      <Box {...containerProps}>
        <Grid {...contentProps}>
          ...
          >
            {[
              { title: "Soileum Network", links: BLOCKSCOUT_LINKS },
              ...(linksData || []),
            ]
              .slice(0, colNum)
              .map((linkGroup) => (
