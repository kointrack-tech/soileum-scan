...
const defaultImageUrl = "/static/og_placeholder.jpg";
...
const meta = Object.freeze({
  ...
  og: {
    ...
    enhancedDataEnabled:
      getEnvValue("NEXT_PUBLIC_OG_ENHANCED_DATA_ENABLED") === "true",
  },
  seo: {
    enhancedDataEnabled:
      getEnvValue("NEXT_PUBLIC_SEO_ENHANCED_DATA_ENABLED") === "true",
  },
});
